      ...
      <section id="produk" className="py-20 px-4 bg-slate-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-14 flex justify-center">
            <Button
              size="lg"
              className="px-12 py-6 bg-gradient-to-r from-cyan-500 to-blue-600 text-white"
              ...
              {selectedProduct.prices && (
                <div className="space-y-3">
                  ...
                  <div className="overflow-x-auto pl-5">
                    <table className="w-full border border-slate-700/50 rounded-xl overflow-hidden">
                      ...
                      <tbody>
                        {selectedProduct.prices.map((item, idx) => (
                          <tr
                            key={idx}
                            className="border-t border-slate-700/40 hover:bg-cyan-500/5 transition-colors"
                          >
