        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white border-b-2 border-gray-200 p-6 flex items-center justify-between">
              ...
              <button
                onClick={() => setSelectedProduct(null)}
                className="w-12 h-12 rounded-lg bg-gray-100 hover:bg-red-100 border-2 border-gray-300 hover:border-red-400 flex items-center justify-center transition-all"
              >
                <X className="text-gray-700 hover:text-red-600" size={24} />
              </button>
            </div>
